...
fn t_tf2a(status: &mut i32) {
    ...
    unsafe {
        j = H1::eraTf2a(b'+' as i8, 4, 58, 20.2, &mut a as *mut f64);
    }
...
fn t_tf2d(status: &mut i32) {
    ...
    unsafe {
        j = H1::eraTf2d(b' ' as i8, 23, 55, 10.9, &mut d as *mut f64);
    }
...
fn t_tporv(status: &mut i32) {
    ...
    unsafe {
        H1::eraS2c(ra, dec, &mut v as *mut [f64; 3] as *mut f64);
        n = H1::eraTporv(
            xi,
            eta,
            &mut v as *mut [f64; 3] as *mut f64,
            &mut vz1 as *mut [f64; 3] as *mut f64,
            &mut vz2 as *mut [f64; 3] as *mut f64,
        );
    }
...
fn t_tpstv(status: &mut i32) {
    ...
    unsafe {
        H1::eraS2c(raz, decz, &mut vz as *mut [f64; 3] as *mut f64);
        H1::eraTpstv(
            xi,
            eta,
            &mut vz as *mut [f64; 3] as *mut f64,
            &mut v as *mut [f64; 3] as *mut f64,
        );
    }

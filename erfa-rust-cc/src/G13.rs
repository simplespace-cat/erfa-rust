...
use crate::H1::*;
#[path = "data/G13/E0Z.rs"]
mod e0z_mod;
use e0z_mod::E0Z;
#[path = "data/G13/E0X.rs"]
mod e0x_mod;
use e0x_mod::E0X;
#[path = "data/G13/E0Y.rs"]
mod e0y_mod;
use e0y_mod::E0Y;
#[path = "data/G13/E1X.rs"]
mod e1x_mod;
use e1x_mod::E1X;
#[path = "data/G13/E1Y.rs"]
mod e1y_mod;
use e1y_mod::E1Y;
#[path = "data/G13/E1Z.rs"]
mod e1z_mod;
use e1z_mod::E1Z;
#[path = "data/G13/S0X.rs"]
mod s0x_mod;
use s0x_mod::S0X;
#[path = "data/G13/S0Y.rs"]
mod s0y_mod;
use s0y_mod::S0Y;
#[path = "data/G13/S0Z.rs"]
mod s0z_mod;
use s0z_mod::S0Z;
#[path = "data/G13/S1X.rs"]
mod s1x_mod;
use s1x_mod::S1X;
#[path = "data/G13/S1Y.rs"]
mod s1y_mod;
use s1y_mod::S1Y;
#[path = "data/G13/S2Y.rs"]
mod s2y_mod;
use s2y_mod::S2Y;
#[path = "data/G13/S2X.rs"]
mod s2x_mod;
use s2x_mod::S2X;
#[path = "data/G13/S1Z.rs"]
mod s1z_mod;
use s1z_mod::S1Z;

// Orientation matrix that aligns simplified VSOP2000 to DE405
...
// eraEpv00    Earth heliocentric & barycentric PV (au, au/d)
pub unsafe fn eraEpv00(date1: f64, date2: f64, pvh: *mut f64, pvb: *mut f64) -> i32 {
    ...
    let pvh = pvh as *mut [[f64; 3]; 2];
    let pvb = pvb as *mut [[f64; 3]; 2];

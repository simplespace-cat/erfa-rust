...
fn t_c2i00a(status: &mut i32) {
    let result = G7_safe::eraC2i00a_safe(2400000.5, 53736.0);
    ...
    match result {
        ...
        Err(_) => {
            *status = 1;
            println!("eraC2i00a_safe failed: unexpected error");
        }
    }
}

fn t_c2i00b(status: &mut i32) {
    let result = G7_safe::eraC2i00b_safe(2400000.5, 53736.0);
    ...
    match result {
        ...
        Err(_) => {
            *status = 1;
            println!("eraC2i00b_safe failed: unexpected error");
        }
    }
}

fn t_c2i06a(status: &mut i32) {
    let result = G7_safe::eraC2i06a_safe(2400000.5, 53736.0);
    ...
    match result {
        ...
        Err(_) => {
            *status = 1;
            println!("eraC2i06a_safe failed: unexpected error");
        }
    }
}
...
fn t_c2ibpn(status: &mut i32) {
    ...
    let result = G7_safe::eraC2ibpn_safe(2400000.5, 50123.9999, &rbpn);
    ...
    match result {
        ...
        Err(_) => {
            *status = 1;
            println!("eraC2ibpn_safe failed: unexpected error");
        }
    }
}
...
fn t_c2ixy(status: &mut i32) {
    ...
    let result = G7_safe::eraC2ixy_safe(2400000.5, 53736.0, x, y);
    ...
    match result {
        ...
        Err(_) => {
            *status = 1;
            println!("eraC2ixy_safe failed: unexpected error");
        }
    }
}
...
fn t_c2ixys(status: &mut i32) {
    ...
    let result = G7_safe::eraC2ixys_safe(x, y, s);
    ...
    match result {
        ...
        Err(_) => {
            *status = 1;
            println!("eraC2ixys_safe failed: unexpected error");
        }
    }
}
...
fn t_c2s(status: &mut i32) {
    ...
    let result = G7_safe::eraC2s_safe(&p);
    ...
    match result {
        ...
        Err(_) => {
            *status = 1;
            println!("eraC2s_safe failed: unexpected error");
        }
    }
}
...
fn t_c2t00a(status: &mut i32) {
    ...
    let result = G7_safe::eraC2t00a_safe(tta, ttb, uta, utb, xp, yp);
    ...
    match result {
        ...
        Err(_) => {
            *status = 1;
            println!("eraC2t00a_safe failed: unexpected error");
        }
    }
}
...
fn t_c2t00b(status: &mut i32) {
    ...
    let result = G7_safe::eraC2t00b_safe(tta, ttb, uta, utb, xp, yp);
    ...
    match result {
        ...
        Err(_) => {
            *status = 1;
            println!("eraC2t00b_safe failed: unexpected error");
        }
    }
}
...
fn t_c2t06a(status: &mut i32) {
    ...
    let result = G7_safe::eraC2t06a_safe(tta, ttb, uta, utb, xp, yp);
    ...
    match result {
        ...
        Err(_) => {
            *status = 1;
            println!("eraC2t06a_safe failed: unexpected error");
        }
    }
}

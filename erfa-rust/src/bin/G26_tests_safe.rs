...
fn t_pn06(status: &mut i32) {
    ...
    let (epsa, rb, rp, rbp, rn, rbpn) = eraPn06_safe(2400000.5, 53736.0, dpsi, deps).unwrap();
...
fn t_pn06a(status: &mut i32) {
    let (dpsi, deps, epsa, rb, rp, rbp, rn, rbpn) = eraPn06a_safe(2400000.5, 53736.0).unwrap();
...
fn t_pnm00a(status: &mut i32) {
    let rbpn = eraPnm00a_safe(2400000.5, 50123.9999).unwrap();
    vvd(
        rbpn[0][0],
...
fn t_pnm00b(status: &mut i32) {
    let rbpn = eraPnm00b_safe(2400000.5, 50123.9999).unwrap();
    vvd(
        rbpn[0][0],
...
fn t_pnm06a(status: &mut i32) {
    let rbpn = eraPnm06a_safe(2400000.5, 50123.9999).unwrap();
    vvd(
        rbpn[0][0],
...
fn t_pnm80(status: &mut i32) {
    let rmatpn = eraPnm80_safe(2400000.5, 50123.9999).unwrap();
    vvd(
        rmatpn[0][0],
...
fn t_pom00(status: &mut i32) {
    ...
    let rpom = eraPom00_safe(xp, yp, sp).unwrap();
...
fn t_ppp(status: &mut i32) {
    let a = [2.0, 2.0, 3.0];
    let b = [1.0, 3.0, 4.0];
    let apb = eraPpp_safe(&a, &b).unwrap();
...
fn t_ppsp(status: &mut i32) {
    ...
    let s = 5.0;
    let b = [1.0, 3.0, 4.0];
    let apsb = eraPpsp_safe(&a, s, &b).unwrap();
...
fn t_pr00(status: &mut i32) {
    let (dpsipr, depspr) = eraPr00_safe(2400000.5, 53736.0).unwrap();
